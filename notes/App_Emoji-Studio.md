...
我们正式开发之前有以下需要准备 ：
1 -  你指导我 使用 powershell  命令建立 本地项目 的目录和文件 ；
2 - 建立GitHub 仓库 ；
3 - 在本地开发文件夹中 建立 doc 文件夹 ，里面存放 blue-print.md 文档，记录 我们项目的 所有开发细节 ，文档的模板我稍后发给你参考 ；
4 - 我和你约定一个 我们开发过程中 的 内部开发版本号 ，用于我们精确 检索 不同时期开发的代码 ，减少你输出太多代码时产生的幻觉和重复修改，让你清晰知道，基于哪一个内部版本号 的代码来增加 或者 减少 功能的代码块 ；
5 - 以下是我给你的 blue-print.md 开发文档 模板 ，内容你要忽略，仅仅参考模板的结构就可以：
